...
<!--////////////////////////////////////////////
    ...
    <v-container  floid class=" px-5 py-5 bg-white overflow-hidden shadow-sm sm:rounded-lg" >
        <div class="d-flex justify-between">
            <h1 class="" style="font-weight: bold; font-size: 20px">Real Time Data</h1>
        </div>

        <v-row style="min-height: 260px; font-size: 25px">
            <v-col cols="12" md="6">
    ...
    <div class="other-admins px-5 py-5 my-9 bg-white overflow-hidden shadow-sm sm:rounded-lg" >
        <h1 class="text-center" style="font-weight: bold; font-size: 20px">Resource Usage</h1>
        <v-row class="pt-6">
            <v-col cols="4">
    ...
    <div class="other-admins px-5 py-5 my-9 bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <h1 class="text-center" style="font-weight: bold; font-size: 20px">Other Admins</h1>
